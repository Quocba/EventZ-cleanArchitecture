...
namespace Event.Infrastructure.Migrations
{
    ...
    [Migration("20250224053133_createTableHistoryPrice1")]
    partial class createTableHistoryPrice1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Event.Domain.Entities.EventSeatsBooking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Event.Domain.Entities.HistoryPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<Guid>("EventPackageRegistrationID")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("event_package_registration_id");
                    ...
                    b.HasIndex("EventPackageRegistrationID");

                    b.ToTable("history_price");
                });
            ...
            modelBuilder.Entity("Event.Domain.Entities.HistoryPrice", b =>
                {
                    b.HasOne("Event.Domain.Entities.EventPackageRegistrations", "EventPackageRegistrations")
                        .WithMany()
                        .HasForeignKey("EventPackageRegistrationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("EventPackageRegistrations");
                });
